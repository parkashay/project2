    ...
    <main class="cd-main-contentS">
        ...
        <section class="large-container">
            <div class="header-image">
                <img src="./assets/images/pokharauniversity-1.jpg" alt="Undergraduate-pokhara-university">
            </div>
            <div class="program-details-container">
                <p class="title">Welcome to SOE Graduate</p>
                <p class="title-description">SOE Graduate is your guide to academics and educational opportunities offered through the Office of the Vice Provost for Undergraduate Education and our campus partners.</p>
                <div class="home-admission-process program-stsgsb4587">
                    <div class="admission-col1">
                        <img src="./assets/images/hero-image/thumbnail_image003_1_0.webp" alt="SOE Graduate">
                    </div>
                ...
                <div class="home-admission-process program-stsgsb4587">
                    ...
                    <div class="admission-col2">
                        <img src="./assets/images/hero-image/soe-graduation.jpg" alt="SOE Graduate">
                    </div>
                </div>
            </div>
            <div class="home-academic bdtyuj58">
                ...
                <div class="more-posts">
                    <a href="./undergraduate.php" class="more-posts-button">Undegraduate</a>
                </div>
            </div>
        </section>
        <!-- footer -->
