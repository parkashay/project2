...
// Download AppGini for free from https://bigprof.com/appgini/download/
	...
	@include_once(__DIR__ . '/hooks/category.php');
	include_once(__DIR__ . '/category_dml.php');
	...
	$x->ColWidth = [150, 150, ];
	$x->ColCaption = ['Id', 'Category name', ];
	$x->ColFieldName = ['id', 'category_name', ];
	$x->ColNumber  = [1, 2, ];
