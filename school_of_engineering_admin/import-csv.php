<?php
	...
	$transformFunctions = [
		'soe_posts' => function($data, $options = []) {
			if(isset($data['category'])) $data['category'] = pkGivenLookupText($data['category'], 'soe_posts', 'category');
		...
		'soe_gallery' => function($data, $options = []) {

			return $data;
		},
		'courses' => function($data, $options = []) {
	...
	$filterFunctions = [
		'soe_posts' => function($data, $options = []) { return true; },
		'category' => function($data, $options = []) { return true; },
		'soe_gallery' => function($data, $options = []) { return true; },
		'courses' => function($data, $options = []) { return true; },
	];
