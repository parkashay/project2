<?php
	...
	$dbUsername = 'root';
	$dbPassword = '';
	$dbDatabase = 'school_of_engineering_pu_admin';
	$dbPort = '3306';
	$appURI = 'school_of_engineering_admin';
	$host = 'localhost';

	$adminConfig = [
		'adminUsername' => "soeadmin",
		'adminPassword' => "\$2y\$10\$0gQ8a8MzvS6ukNMeyarGpekXu..1g5PsbajqJA59ppJ/LzU.tJDTm",
