    ...
    <main class="cd-main-contentS">
        ...
        <section class="large-container">
            <div class="header-image text-over-image">
                <img class="bg-isolated-img" src="./assets/images/background-image/campus_aerial-13_resize_0.jpg" alt="about-pokhara-university-soe">
                <div class="text-over-image-text">
                    <p class="title txt-clr-1">About SOE</p>
                    <p class="title-description blinking-text">SOE is a place of discovery, creativity and innovation located in Lekhnath, Pokhara on the land of nature </p>
                </div>
            </div>
            <div class="simple-layout">
                <div class="short-large-txt">
                    ...
                    <a href="#" class="call-to-action-btn"><i class="fa-solid fa-arrow-right"></i> Learn about our history </a>
                </div>
                ...
                <div class="odd-bg section-cb48">
                    <div class="container-content-two-col">
                        <div class="side-img-text admission-overlap">
                            <div class="floating-image"><img src="./assets/images/hero-image/soe-graduation.jpg" alt="pu-admission"></div>
                            <div class="main-content-xr45 overlap-bg-xr45">
                                ...
                                <p class="content-xr45-text">
                                    <a href="./how-to-apply.php" class="call-to-action-btn"><i class="fa-solid fa-arrow-right"></i> Enroll now </a>
                                </p>
                            </div>
                        </div>
