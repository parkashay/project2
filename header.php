...
<!-- second nav -->
<header class="header">
    <a id="cd-logo" href="./index.php"><img src="./assets//images/logo_pu.png" alt="School of engineering pu">School Of Engineering</a>
            ...
            <li>
                <div class="search-container">
                    <form action="search.php" method="POST" name="search">
                        <input class="search expandright" id="searchright" type="search" placeholder="Search" name="search[keyword]">
...
<nav id="cd-lateral-nav">
    <ul class="cd-navigation cd-single-item-wrapper">
        <li class="form-center">
            <form action="search.php" method="POST" class="form-inline my-2 my-lg-0 header-search search-small search-small-screen" name="form">
                <input class=" form-control mr-sm-2" type="search" placeholder="Search here..." required type="text" name="search[keyword]">
            </form>
        </li>
    </ul>
